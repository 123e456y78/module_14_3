...
async def get_buying_list(message: types.Message):
        await message.answer(f"Название: Product1| Описание: описание  | Цена:100")
        file_path1 = f'12.jpg'
        try:
            ...
            print(e)
        await message.answer(f"Название: Product1| Описание: описание  | Цена:200")
        file_path2 = f'13.jpg'
        try:
            ...
            await message.answer(f"Произошла ошибка: {e}")
            print(e)
        await message.answer(f"Название: Product1| Описание: описание  | Цена:300")
        file_path3 = f'14.jpg'
        try:
            ...
            await message.answer(f"Произошла ошибка: {e}")
            print(e)
        await message.answer(f"Название: Product1| Описание: описание  | Цена:400")
        file_path4 = f'15.jpg'
        try:
            with open(file_path4, 'rb') as file:
                photo = FSInputFile(file_path4)
                await message.answer_photo(photo)
        except FileNotFoundError:
            await message.answer("Файл не найден.")
        except Exception as e:
